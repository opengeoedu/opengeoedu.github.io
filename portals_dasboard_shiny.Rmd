...
```{r fig.height=8}
tags$div(align="middle", style="text-align:center", id="main-filter-group",
 bscols(widths = c(6,6),
...
#create and save costum selection 
...
#jsonlite::write_json(country_json, "data/country_map.json",pretty = TRUE)
htmltools::tags$script(id="country_select_map", type= "application/json",
                       as.character(jsonlite::toJSON(country_json, pretty = TRUE)))
...
#   if(scripts[i].getAttribute('data-for') == 'country-select'){
#     var dataNode = scripts[i];
#     dataNode.innerText =  ", jsonlite::toJSON(country_json, pretty = TRUE), ";
#   }
# }
# "))
